...
<div class="box box-success">
  <div class="box-header with-border">
    ...
    <a class="btn btn-success btn-xs createNewUserSchool"  data-id=""  href="javascript:void(0)" id="createNewQuestionIAF">
  ...
  <table class="table table-condensed">
                       ...
                       {{  $users->lastname_parent }} 
                        ...
                        <a class="btn btn-info btn-xs  viewUser"  data-id="{{$users->username}}"  href="javascript:void(0)"><i class="fa fa-eye" ></i></a>
                             ...
                             <a class="btn btn-danger btn-xs   deleteUser_sc" data-id="{{$users->username}}" data-idd="{{$users->id}}" href="javascript:void(0)"><i class="fa fa-trash"></i></a>
                        </td>
                        </tr>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title"><lable id="modelHeading"> </lable></h4>
              </div>
                        ...
                        <div class="col-md-6">
                          ...
                          <label>ชื่อนักเรียน:</label>
                            <select class="form-control select2" style="width: 100%;"   name="id_student"  id="id_student" required>
                                ...
                                <option value="{{ $namestudens->student_code_id }}"> {{$namestudens->name}} {{$namestudens->lastname}} </option>
